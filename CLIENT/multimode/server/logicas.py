...
class Router:
    ...
    @staticmethod
    def recibir_bytes(leng: int, socket_de_origen: socket) -> bytearray:
        """
...
class Instructions:
    ...
    @staticmethod
    def user_name_check(errores: list) -> dict:
        if errores:
            order = {
                'comando': 'user_name_check',
                'errores': errores,
                'valid': False
            }
            return order
    ...
    @staticmethod
    def info_adv(name: str) -> dict:
        order = {
            'comando': 'info_contrincante',
            'name': name
        }
        return order

    @staticmethod
    def avisar_abandono_espera() -> dict:
        order = {
            'comando': 'adv_left_wait'
        }
        return order

    @staticmethod
    def informe_tiempo(time: int) -> dict:
        order = {
            'comando': 'tick',
            'time': int(time)
        }
